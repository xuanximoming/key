...
namespace DrectSoft.Common.Ctrs.OTHER
{
    ...
    public partial class DevTextEditPost : DevExpress.XtraEditors.TextEdit
    {
        ...
        public DevTextEditPost()
        {
            InitializeComponent();
            this.Properties.MaxLength = 6;
        }

        public DevTextEditPost(IContainer container)
        {
            container.Add(this);
