...
{
    public partial class PaintDesignPanel
        : UserControl, IPaintPanel
    {
        ...
        public PaintDesignPanel(bool needSave)
        {
            InitializeComponent();
            Init();
            if (!needSave)
        ...
        private void Source_Loaded(object sender, EventArgs e)
        {
            ...
            this.Size = new Size(width + 95, Math.Max(height + 95, 300));
        }
        ...
        private void newPictureStrip1_FontSizeChanged(object sender, SizeEventArgs e)
        {
            controlSurface1.TextEditor.FontSize = e.FontSize;
        }
    }
}
