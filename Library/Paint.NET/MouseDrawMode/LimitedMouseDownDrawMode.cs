...
{
    public class LimitedMouseDownDrawMode
        : IMouseDrawMode
    {
        ...
        public LimitedMouseDownDrawMode(IShape shape)
        {
            _shape = shape;
        }
            ...
            Point point, MouseButtons button, MouseStates state)
        {
            ...
            if (_shape.Data.Points != null &&
                _shape.Data.Points.Length > _shape.MinPoints &&
                (button & MouseButtons.Right) == MouseButtons.Right &&
