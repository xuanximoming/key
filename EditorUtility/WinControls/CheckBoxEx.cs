...
namespace DrectSoft.Library.EditorUtility.WinControls
{
	...
	public class CheckBoxEx : System.Windows.Forms.CheckBox
	{
		...
		public CheckBoxEx()
		{
			...
			checkMarkChecked = ResourceUtil.LoadBitmapResource(Type.GetType("DrectSoft.Library.EditorUtility.WinControls.CheckBoxEx"),
				                                "DrectSoft.Library.EditorUtility.Resources.Controls", "CheckMarkChecked");
			Debug.Assert(checkMarkChecked != null);
			checkMarkUnchecked = ResourceUtil.LoadBitmapResource(Type.GetType("DrectSoft.Library.EditorUtility.WinControls.CheckBoxEx"),
				                                "DrectSoft.Library.EditorUtility.Resources.Controls", "CheckMarkUnchecked");
