...
using DrectSoft.Library.EditorUtility.Collections;
using DrectSoft.Library.EditorUtility.General;
using DrectSoft.Library.EditorUtility.Menus;
using DrectSoft.Library.EditorUtility.Win32;
...
namespace DrectSoft.Library.EditorUtility.WinControls
{
    ...
    [ToolboxBitmap(typeof(DrectSoft.Library.EditorUtility.WinControls.OutlookBar),
    "DrectSoft.Library.EditorUtility.WinControls.OutlookBar.bmp")]
    public class OutlookBar : System.Windows.Forms.Control
    {
        ...
        public OutlookBar()
        {
            ...
            // Load drag cursor
            Assembly myAssembly = Assembly.GetAssembly(Type.GetType("DrectSoft.Library.EditorUtility.WinControls.OutlookBar"));
            Stream cursorStream = myAssembly.GetManifestResourceStream("DrectSoft.Library.EditorUtility.Resources.DragCursor.cur");
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            //DrawArrowButtons(g);//added by bwy
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                DoDragDrop("xxx", DragDropEffects.All);
            }
            #endregion bwy :
