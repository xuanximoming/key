...
namespace DrectSoft.Library.EditorUtility.WinControls
{
	...
	public class ListViewEx : ListView
	{
		...
		private void InitializeCheckBoxesImageList()
		{
			...
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("DrectSoft.Library.EditorUtility.WinControls.ListViewEx"));
			ResourceManager rm = new ResourceManager("DrectSoft.Library.EditorUtility.Resources.SortedListView", thisAssembly);
