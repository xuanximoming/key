...
using DrectSoft.Library.EditorUtility.CommandBars;

namespace DrectSoft.Library.EditorUtility.Menus
{
	/// <summary>
	...
	public class MenuItemEx : MenuItem
	{
		...
		static MenuItemEx()
		{
			...
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("DrectSoft.Library.EditorUtility.Menus.MenuItemEx"));
			ResourceManager rm = new ResourceManager("DrectSoft.Library.EditorUtility.Resources.ImagesMenu", thisAssembly);
