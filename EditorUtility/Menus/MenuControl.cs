...
namespace DrectSoft.Library.EditorUtility.Menus
{
	...
	[Designer(typeof(DrectSoft.Library.EditorUtility.Menus.MenuControlDesigner))]
	public class MenuControl : ContainerControl, IMessageFilter
	{
		...
		static MenuControl()
		{
			...
			_menuImages = ResourceUtil.LoadImageListResource(Type.GetType("DrectSoft.Library.EditorUtility.Menus.MenuControl"),
