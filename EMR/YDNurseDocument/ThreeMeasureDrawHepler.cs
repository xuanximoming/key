...
namespace DrectSoft.Core.NurseDocument
{
    public class ThreeMeasureDrawHepler
    {
        ...
        //                if (iconName == DataLoader.KOUWEN)
        //                {
        //                    gph.DrawImage(LegendIconSource.dic_legendIcon[iconName], pos.X - 3, pos.Y - 3, m_lineIconSize.Width+2, m_lineIconSize.Height+2);
        //                }
        //                else
        //                {
        //                    gph.DrawImage(LegendIconSource.dic_legendIcon[iconName], pos.X - 3, pos.Y - 3, m_lineIconSize.Width, m_lineIconSize.Height);
        //                }
        //            }
        //            else
        //            {
        //                gph.DrawImage(LegendIconSource.dic_legendIcon[fieldName], pos.X - 3, pos.Y - 3, m_lineIconSize.Width, m_lineIconSize.Height);
        //            }
        //            if (linked)
        //            {
        //                if (preDataPoint != null)
        //                {
        //                    gph.DrawLine(GetColorPen(dicVitalSignsLineColor[fieldName]), preDataPoint.ToXCoordinate(), preDataPoint.ToYCoordinate(dicVerticalCoordinate[fieldName]) + 1, dp.ToXCoordinate(), dp.ToYCoordinate(dicVerticalCoordinate[fieldName]) + 1);
        //                }
        //            }
        //            preDataPoint = dp;
        //            if (temp)  //该时段存在"外出"等病人状态
        ...
        /// 绘制事件体征数据点
        /// </summary>
        /// <param name="dataList">一周数据 升序排列</param>
        ...
        //            {
        //                gph.DrawString(sb.ToString() + dp.value + "|" + MethodSet.NumerricTimeToString(dp.date), fontText, ConfigInfo.m_patientStateTextColor, recf, sf);
        //                //return;
        //                return specialPatientStateDataPoints;
        //            }
        //            //if (index == dataList.Count && specialState && ConfigInfo.inUsed == "1")
        //            if (index == dataList.Count && specialState)
        //            {
        //                gph.DrawString(sb.ToString(), fontText, ConfigInfo.m_patientStateTextColor, recf, sf);
        //                return specialPatientStateDataPoints;
        ...
        //            sb.Append(dp.value + "|" + MethodSet.NumerricTimeToString(dp.date)+" ");
        //        }
        //        return specialPatientStateDataPoints;
        //    }
        //    catch (Exception ex) { throw ex; }
        ...
        //        DataCollection patientState = dataLoader.GetPatStates(dte, endDteStates,dataLoader.patid);
        ...
        //            {
        //                if (fs.stateName.Equals(dp.value))
        //                {
        ...
        //            LinkDifferentTypeDataPoint(VitalSignsDataPointsPHYSICALCOOLING,VitalSignsDataPointsTEMPERATURE,brush,DashStyle.Custom);
        ...
        //            else
        //            {
        //                //FillNullForPulseAndHeartrate(VitalSignsDataPointsPULSE, VitalSignsDataPointsHEARTRATE);
        //                //FillNullForPulseAndHeartrate(VitalSignsDataPointsHEARTRATE, VitalSignsDataPointsPULSE);
        ...
        /// 解决脉搏心率互补后画图标错误问题
        /// 脉搏心率各时间段值互补后再次画数据点导致所有点使用同数据元对应图片
        /// </summary>
        /// <param name="g"></param>
        //public void DrawDataImage(Graphics g)
        //{
        ...
        //                FormatePulseHeartRateDataPointsAndLink(VitalSignsDataPointsPULSE, VitalSignsDataPointsHEARTRATE);
        //            }
        //            //--------------------------------Modify by xlb 2013-05-27脉搏心率值互补后再执行绘制数据点导致画图标错误---------------------------------
        //            //FillVitalSignsData(VitalSignsDataPointsPULSE);
        //            //FillVitalSignsData(VitalSignsDataPointsHEARTRATE);
        //        }
        //        else
        ...
        //        //{
        //        //    if (dp.temperatureType.ToString().Trim().Equals("8801"))
        //        //    {
        //        //        foreach (DataPoint dpPulse in VitalSignsDataPointsPULSE)
        //        //        {
        //        //            if (dp.ToXCoordinate() == dpPulse.ToXCoordinate()
        //        //                && dp.ToYCoordinate(ConfigInfo.dicVerticalCoordinate[VitalSignsDataPointsTEMPERATURE.FieldName])
        //        //                == dp.ToYCoordinate(ConfigInfo.dicVerticalCoordinate[VitalSignsDataPointsPULSE.FieldName])) 
        //        //            {
        ...
        public void DrawDataImage(Graphics g)
        {
            try
            {
                ...
                if (MainNursingMeasure.m_showTempareture && ConfigInfo.dicVerticalCoordinate[DataLoader.TEMPERATURE].hide == "0")//显示体温线
                {
                    ...
                    //注销(2013-06-24物理升温和体温垂直连线提前到连线前避免点值已清除无法连线)
                    //LinkDifferentTypeDataPoint(VitalSignsDataPointsPHYSICALHOTTING, VitalSignsDataPointsTEMPERATURE, brush, DashStyle.Custom);
