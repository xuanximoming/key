...
{
    public partial class NursingRecordNew : DevBaseForm
    {
        ...
        public void RefreshForm(string curPat)
        {
            try
            {
                ucNursingRecordTableNew1.RefreshFormControls(curPat);
            }
            catch (Exception ex)
            {
        ...
        public NursingRecordNew(IEmrHost App, string currentInpatient)
        {
            try
            {
        ...
        /// 刷新基本信息
        /// </summary>
        /// <param name="m_currentInpatient"></param>
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (DateTime.Parse(dateEdit.DateTime.Date.ToString("yyyy-MM-dd")) >= DateTime.Parse(DateTime.Parse(m_InTime).ToString("yyyy-MM-dd")))
                {
                    ...
                    if (ucNursingRecordTableNew1.SaveUCNursingRecordTable(dateEdit.DateTime.Date.ToString("yyyy-MM-dd"), NoOfInpat))
                    {
                        //this.Close();
                    }
                    // }
        ...
        public void dateEdit_DateTimeChanged(object sender, EventArgs e)
        {
            try
            {
                if (m_currentInpatient != null)
                {
                    ...
                    ucNursingRecordTableNew1.GetNotesOfNursingInfo(dateEdit.DateTime.Date.ToString("yyyy-MM-dd"), NoOfInpat);
        ...
        private void ucNursingRecordTableNew1_Load(object sender, EventArgs e)
        {

        }

        private void textEdit84_EditValueChanged(object sender, EventArgs e)
        {
