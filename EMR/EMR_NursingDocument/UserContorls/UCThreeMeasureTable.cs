...
namespace DrectSoft.Core.EMR_NursingDocument.UserControls
{
    public partial class UCThreeMeasureTable : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void PaintPatientBaseInformation(PictureBox pictureBox, Graphics g)
        {
            ...
            str = "年龄:";
            g.DrawString(str, font, Brushes.Black, patientInfoLocation.AgeX, patientInfoLocation.InpatientInformationY);
        ...
        private void PaintThirdPartOfTable(PictureBox pictureBox, Graphics g)
        {
            ...
            #region 绘制血压，总入量，总出量，引流量，身高，体重，过敏药物，特殊治疗，其他1， 其他2
        ...
        */
        ...
        /// </summary>
        private void GetBedIDAndDeptName(DateTime inTime, DateTime allocateDateTime, string noOfInpat, IDataAccess sqlHelper)
        {
        ...
        public void SetAllocateDateTime(DateTime dateTimeAllocate, IDataAccess sqlHelper)
        {
            m_DataTimeAllocate = dateTimeAllocate;

            GetBedIDAndDeptName(Convert.ToDateTime(PatientInfo.InTime), m_DataTimeAllocate, PatientInfo.NoOfInpat, sqlHelper);
        }

        public void SetAllocateDateTime(IDataAccess sqlHelper)
        {
        ...
        public void SetAllocateDateTime(int days, IDataAccess sqlHelper)
        {
        ...
        public void SetPatientInfo(DataTable dataTablePatientInfo, IDataAccess sqlHelper)
        {
        ...
        public void PrintAllDocument()
        {
            ...
            for (int indexWeek = fromWeek; indexWeek <= toWeek; indexWeek++)
            {
                ...
                SetAllocateDateTime(patientInTime.AddDays(indexWeek * 7), m_app.SqlHelper);
                LoadData();
                this.Refresh();
