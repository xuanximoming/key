...
namespace DrectSoft.Core.EMR_NursingDocument.PublicSet
{
    abstract class MethodSet
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetHospitalInfo()
        {
        ...
        /// <returns></returns>
        public static DataTable GetStateData(string NoPatID)
        {
        ...
        public static string SaveStateData(PatStateEntity patStateEnt, string edittype)
        {
            ...
            sqlParam[3].Value = patStateEnt.PATID;
        ...
        public static string GetConfigValueByKey(string key)
        {
            ...
            DataTable dt = MethodSet.sql_Helper.ExecuteDataTable(sql1, CommandType.Text);
