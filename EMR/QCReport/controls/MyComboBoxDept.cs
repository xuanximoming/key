...
{
    public partial class MyComboBoxDept : System.Windows.Forms.ComboBox,IControlDataInit
    {
        ...
        public void InitControlBindData()
        {
            try
            {
                ...
                DataTable Dept = DrectSoft.DSSqlHelper.DS_SqlHelper.ExecuteDataTable("emrproc.usp_GetMedicalRrecordViewFrm",sqlParam, CommandType.StoredProcedure);
