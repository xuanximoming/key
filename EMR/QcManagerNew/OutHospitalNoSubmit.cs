...
namespace YindanSoft.Emr.QcManagerNew
{
    ...
    {
        IYidanEmrHost m_app;
        public OutHospitalNoSubmit(IYidanEmrHost app)
        {
            InitializeComponent();
            m_app = app;
        }
        ...
        public void BindDataSouce(string deptid)
        {
            ...
            DataTable dt = m_app.SqlHelper.ExecuteDataTable(string.Format(SQLUtil.sql_QueryOutHospitalNOSubmit, deptid, sexid, timebegin, timeend, patname, recordid));
