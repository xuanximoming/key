...
namespace YindanSoft.Emr.QcManagerNew
{
    ...
    {
        IYidanEmrHost m_app;
        public QC_RecordByDoctor(IYidanEmrHost app)
        {
            InitializeComponent();
            m_app = app;
            Init();
        ...
        private void btn_query_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = m_app.SqlHelper.ExecuteDataTable(string.Format(SQLUtil.sql_QueryByDoctor, userid, dateBegin, dateEnd, depid));
