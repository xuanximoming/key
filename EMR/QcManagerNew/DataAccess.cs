...
namespace DrectSoft.Emr.QcManagerNew
{
    abstract class DataAccess
    {
        ...
        {
            string sql = "";
            string sql_iem_mainpage_no = "select iem_mainpage_no from iem_mainpage_basicinfo_2012 where noofinpat = '" + noOfInpat + "' and valide = 1";
            ...
            {
                case 0:
                    sql = "select * from iem_mainpage_basicinfo_2012 where noofinpat = '" + noOfInpat + "'  and valide = 1";
                    return m_SqlHelper.ExecuteDataTable(sql);
                case 1:

                    sql = "select * from iem_mainpage_diagnosis_2012 where iem_mainpage_no = '" + iem_mainpage_no + "' and valide = 1";
                    return m_SqlHelper.ExecuteDataTable(sql);
                case 2:
                    sql = "select * from iem_mainpage_operation_2012 where iem_mainpage_no = '" + iem_mainpage_no + "' and valide = 1";
                    return m_SqlHelper.ExecuteDataTable(sql);
                case 3:
