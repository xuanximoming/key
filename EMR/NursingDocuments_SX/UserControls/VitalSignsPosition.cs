...
namespace DrectSoft.Core.NursingDocuments.UserControls
{
    ...
    public class VitalSignsPosition
    {
        ...
        public string GetConflictPointType(string currentType, string currentSubType, string nextType, string nextSubType)
        {
            ...
            {
                if (currentSubType == UCThreeMeasureTable.VitalSignsTiWenType.KouWen.ToString()
                    || nextSubType == UCThreeMeasureTable.VitalSignsTiWenType.KouWen.ToString())
                {
                    returnValue = ConflictPointType.MaiBoTiWenKou.ToString();
                }
                else if (currentSubType == UCThreeMeasureTable.VitalSignsTiWenType.GangWen.ToString()
                    || nextSubType == UCThreeMeasureTable.VitalSignsTiWenType.GangWen.ToString())
                {
                    returnValue = ConflictPointType.MaiBoTiWenGang.ToString();
                }
                else if (currentSubType == UCThreeMeasureTable.VitalSignsTiWenType.YeWen.ToString()
                    || nextSubType == UCThreeMeasureTable.VitalSignsTiWenType.YeWen.ToString())
                {
