    ...
    public class ZYButton : ZYElement //ZYTextBlock   
    {
        ...
        public override bool RefreshView()
        {
            this.RefreshSize();
                ...
                int width = DrectSoft.Library.EmrEditor.Src.Gui.GraphicsUnitConvert.Convert(r.Width, GraphicsUnit.Document, GraphicsUnit.Pixel);
                int height = DrectSoft.Library.EmrEditor.Src.Gui.GraphicsUnitConvert.Convert(r.Height, GraphicsUnit.Document, GraphicsUnit.Pixel);
                r.Width = width;
                r.Height = height;
            ...
            {
                OwnerDocument.View.Graph.DrawString(this.Name, this.Font, Brushes.Black, this.Bounds, strFormat);
            }
            return true;
