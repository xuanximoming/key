namespace DrectSoft.Emr.TemplateFactory
{
    partial class FooterFrm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FooterFrm));
            ...
            this.label1.Text = "说明：请输入页脚字符串，当前页号请用 [%pageindex%] 表示，总页数请用 [%pagecount%] 表示 ";
            // 
            // textBox1
            // 
            ...
            this.ClientSize = new System.Drawing.Size(649, 127);
            ...
            this.Text = "页脚模板";
            this.Load += new System.EventHandler(this.FooterFrm_Load);
