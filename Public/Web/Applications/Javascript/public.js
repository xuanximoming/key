...
{
   var feature="width="+width+",height="+height+",top=100,left=100,menubar=no,toolbar=no,location=no,directories=no,status=no,resizable=yes,scrollbars=yes";
...
{
   var feature="dialogWidth="+width+"px;dialogHeight="+height+"px;center=yes;help=no;status=no";
