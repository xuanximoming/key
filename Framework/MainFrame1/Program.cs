...
namespace MainFrame
{
    static class Program
    {
        ...
        /// </summary>
        /// <returns></returns>
        private static bool IsReg()
        {
            //判断机器是否进行了注册 如果注册了才能用
            //bool IsRegDate = KEY.Key.ISRegTime();
            //if (!IsRegDate)
            //{
            //    Common.Ctrs.DLG.MessageBox.Show("系统已超过有效期，请联系管理员");
            //    return false;
            //}
            //bool IsRegPC = KEY.Key.ISRightPCHandInfo();
            //if (!IsRegPC)
            //{
            //    Common.Ctrs.DLG.MessageBox.Show("本机器未注册，不能使用系统，请联系管理员");
            //    return false;
            //}
            return true;
        }
        ...
        static AppDomain GetCustomAppDomain()
        {
            ...
            ads.ApplicationName = "DrectSoftEMR";
            ...
            return AppDomain.CreateDomain("DrectSoftEMR", null, ads);
        }
        /// <summary>
        /// 检查注册信息  包括医院名称与注册时间
        /// </summary>
