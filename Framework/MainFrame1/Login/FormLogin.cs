...
namespace DrectSoft.MainFrame
{
    ...
    public partial class FormLogin : DevBaseForm, ICustomMessageBox
    {
        ...
        {
            /*
            var sql_helper = DataAccessFactory.GetSqlDataAccess("EMRDB");
            ...
            string flieName = AppDomain.CurrentDomain.BaseDirectory + "\\EmrVersion.menu";
            XmlDocument doc = new XmlDocument();
            doc.Load(flieName);
            XmlNode xmlNode = doc.SelectSingleNode("Version");
            if (xmlNode.InnerText == dataVersion)
             * */
            {
                lblVersion.Text = "1.7";
            }
        ...
        private void InitializeUI()
        {
            ...
            try
            {
                //panelForm.BackgroundImage = ResourceManager.GetImage(ResourceNames.LogonBackGround_Emr);
                // 加载登录按钮图标
                //buttonLogIn.BackgroundImage = ResourceManager.GetImage(ResourceNames.LogInButton);
        ...
        void textBoxUserID_Leave(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                //labelUserName.Text = DrectSoft.MainFrame.Properties.Resources.ResLoginOperatorNotExist;
        ...
        {
            //if (Common.Ctrs.DLG.MessageBox.Show("您确定要退出系统吗？", "退出系统", Common.Ctrs.DLG.MyMessageBoxButtons.OkCancel) == DialogResult.OK)
            //{
        ...
        void ProcessLogin()
        {
            ...
            //memoEdit1.Text = DrectSoft.MainFrame.Properties.Resources.ResInLoginProcess;
        ...
        private void FormLogin_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!ISIp(ip))
                {
                    ...
                    // MessageBox.Show("配置的自动更新服务器IP地址不是有效的ip地址!");
                    return;
                }
