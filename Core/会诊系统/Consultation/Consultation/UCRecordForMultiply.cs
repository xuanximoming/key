...
namespace DrectSoft.Core.Consultation
{
    public partial class UCRecordForMultiply : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UCRecordForMultiply(string noOfFirstPage, IEmrHost host, string consultApplySn)
            : this()
        {
        ...
        public void ReadOnlyControl()
        {
            ...
            simpleButtonComplete.Enabled = false;
        ...
        {
            CheckISApprove();
            this.ActiveControl = ucRecordResultForMultiply;
