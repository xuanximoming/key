...
namespace YidanSoft.Core.OwnBedInfo
{
    ...
    public class DataManager : IDisposable
    {
        ...
        public DataTable GetBabyInfo(string NOOFINPAT)
        {
            ...
            where a.mother='{0}' and  t.categoryid = '3' ", NOOFINPAT);
        ...
        {
            string sql = string.Format(@"select a.noofinpat,a.name as patname,a.agestr,
                        b.name as sexname,a.isbaby  from inpatient a    JOIN dictionary_detail b
                        on  b.detailid = a.sexid
                        where b.categoryid = '3' and (a.noofinpat='{0}' or a.mother='{0}') ", NOOfINPAT);
            return m_App.SqlHelper.ExecuteDataTable(sql, CommandType.Text);
        }
