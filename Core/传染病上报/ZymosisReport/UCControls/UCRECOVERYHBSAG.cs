...
{
    public partial class UCRECOVERYHBSAG : DevExpress.XtraEditors.XtraUserControl,IZymosisReport
    {
        /// <summary>
        /// add by ck 2013-8-19 恢复期血清HBsAg阴转,抗HBs阳转
        /// </summary>
        public UCRECOVERYHBSAG()
        {
            try
            {
                InitializeComponent();
