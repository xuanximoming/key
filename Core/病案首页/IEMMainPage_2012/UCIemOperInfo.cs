...
namespace DrectSoft.Core.IEMMainPage
{
    public partial class UCIemOperInfo : UserControl
    {
        ...
        private void DeleteItem()
        {
            ...
            if (DrectSoft.Common.Ctrs.DLG.MyMessageBox.Show("您确定要删除该项手术记录吗？确定后生效，该操作不可恢复。", "删除手术记录", DrectSoft.Common.Ctrs.DLG.MyMessageBoxButtons.OkCancel) == DialogResult.Cancel)
            {
                return;
            }
