...
namespace DrectSoft.Core.IEMMainPage
{
    ...
    public class Iem_Mainpage_Diagnosis
    {
        ...
        public string Quality_Control_DatePrint
        {
            get
            {
                if (string.IsNullOrEmpty(_Quality_Control_Date))
                    return "";
                else
        ...
        public DataTable OutBabyTable
        {
            get
            {
                if (_OutBabyTable == null)
                {
                    ...
                    DataColumn MIDWIFERYID = new DataColumn("JCZ", Type.GetType("System.String"));
                    ...
                    _OutBabyTable.Columns.Add(MIDWIFERYID);
