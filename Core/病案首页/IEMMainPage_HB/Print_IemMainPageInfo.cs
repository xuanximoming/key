        ...
        public DataTable OutDiagTable
        {
            get
            {
                if (_OutDiagTable == null)
                {
                    ...
                    DataColumn dcMorphoLogyName = new DataColumn("MorphoLogyName", Type.GetType("System.String"));// add jxh
                    DataColumn dcMorphoLogyIcd = new DataColumn("MorphoLogyIcd", Type.GetType("System.String"));
                    ...
                    _OutDiagTable.Columns.Add(dcMorphoLogyName);
                    _OutDiagTable.Columns.Add(dcMorphoLogyIcd);
