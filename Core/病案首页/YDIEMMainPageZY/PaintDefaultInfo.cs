...
namespace DrectSoft.Core.IEMMainPageZY
{
    ...
    public class Iem_Default_PaientInfo
    {
        ...
        /// Add by xlb 2013-06-18
        /// </summary>
        private string outWardDateMonth;
        ...
        public string OutWardMonth
        {
            get
            {
                return outWardDateMonth;
            }
            set
            {
                outWardDateMonth = value;
            }
        }
        ...
        public string OutWardDay
        {
            get
            {
                return outWardDateDay;
            }
            set
            {
                outWardDateDay = value;
            }
        }
        ...
        /// Add by xlb 2013-06-18
        /// </summary>
        private string outWardDateHour;
        ...
        public string OutWardHour
        {
            get
            {
                return outWardDateHour;
            }
            set
            {
                outWardDateHour=value;
            }
        }
