...
namespace DrectSoft.Core.IEMMainPageZY
{
    ...
    public class Iem_Mainpage_Basicinfo
    {
        ...
        public string AdmitDateMonth
        {
            ...
            set 
            {
                admitDateMonth = value;
            }
        }

        private string admitDateDay;
        ...
        private string outWardDateYear;
        ...
        public string OutWardDateYear
        {
            get
            {
                return outWardDateYear;
            }
            set 
            {
                outWardDateYear = value;
            }
        }

        private string outWardMonth;

        /// <summary>
        /// 出院时间的月份 用于打印分开显示
        /// </summary>
        public string OutWardMonth
        {
            get 
            {
                return outWardMonth;
        ...
        private string outWardDay;

        /// <summary>
        /// 出院时间的天
        /// </summary>
        public string OutWardDay
        {
            get 
            {
                return outWardDay;
        ...
        /// ASA分级评分
        /// </summary>
        private string asaScore;

        /// <summary>
        /// ASA分级评分
        /// </summary>
        public string AsaScore
        {
            get
            {
                return asaScore;
    ...
    public class Iem_Mainpage_Diagnosis
    {
        ...
        private string _quality_Cotnrol_DateYear;

        /// <summary>
        /// 质控时间年份
        /// Add by xlb 2013-04-24
        /// </summary>
        public string Quality_Control_DateYear
        {
            get 
            {
                return _quality_Cotnrol_DateYear;
            }
            set 
            {
                _quality_Cotnrol_DateYear = value;
            }
        }

        private string _quality_Control_DateMonth;
        ...
        public string Quality_Control_DateMonth
        {
            get 
            {
                return _quality_Control_DateMonth;
            }
            set 
            {
                _quality_Control_DateMonth = value;
            }
        }

        private string _qulity_Control_DateDay;
        ...
        public string Quality_Control_DateDay
        {
            get 
            {
                return _qulity_Control_DateDay;
            }
            set 
            {
                _qulity_Control_DateDay = value;
            }
        }
        ...
        /// 病人出院情况
        /// </summary>
        private string _iemInpatOutHosStatus;

        /// <summary>
        /// 病人出院情况
        /// </summary>
        public string IemInpatOutHosStatus
        {
            get
            {
                return _iemInpatOutHosStatus;
            }
            set
            {
                _iemInpatOutHosStatus = value;
            }
        }
        ...
        /// 疾病是否疑难杂症
        /// </summary>
        private string _iemDieaseYNZZ;

        /// <summary>
        /// 疾病是否疑难杂症
        /// </summary>
        public string IemDieaseYNZZ
        {
            get
            {
                return _iemDieaseYNZZ;
            }
            set
            {
                _iemDieaseYNZZ = value;
            }
        }
        ...
        /// 门诊与出院
        /// </summary>
        private string _iemMZYOutHos;

        /// <summary>
        /// 门诊与出院
        /// </summary>
        public string IemMZYOutHos
        {
            get
            {
                return _iemMZYOutHos;
            }
            set
            {
                _iemMZYOutHos = value;
        ...
        /// 入院与出院
        /// </summary>
        private string _iemInHosYOutHos;

        /// <summary>
        /// 入院与出院
        /// </summary>
        public string IemInHosYOutHos
        {
            get
            {
                return _iemInHosYOutHos;
            }
            set
            {
                _iemInHosYOutHos = value;
            }
        }
        ...
        /// 临床与病理
        /// </summary>
        private string _iemLCYBL;

        /// <summary>
        /// 临床与病理
        /// </summary>
        public string IemLCYBL
        {
            get
            {
                return _iemLCYBL;
        ...
        /// 反射与病理
        /// </summary>
        private string _iemFSYBL;

        /// <summary>
        /// 反射与病理
        /// </summary>
        public string IemFSYBL
        {
            get
            {
                return _iemFSYBL;
        ...
        /// 抢救次数
        /// </summary>
        private string _iemQJCS;

        /// <summary>
        /// 抢救次数
        /// </summary>
        public string IemQJCS
        {
            get
            {
                return _iemQJCS;
        ...
        /// 成功次数
        /// </summary>
        private string _iemSuccessTimes;

        /// <summary>
        /// 成功次数
        /// </summary>
        public string IemSuccessTimes
        {
            get
            {
                return _iemSuccessTimes;
            }
            set
            {
                _iemSuccessTimes = value;
            }
        }
        ...
        /// 病人来源
        /// </summary>
        private string _iemInpatLY;

        /// <summary>
        /// 病人来源
        /// </summary>
        public string IemInpatLY
        {
            get
            {
                return _iemInpatLY;
        ...
        public string YBZLFY
        {
            get
            {
                if (_YBZLFY == null || _YBZLFY.Trim() == "")
                    _YBZLFY = "-";
                return _YBZLFY;//原来写错了 add by ywk 2013年6月4日 18:13:03
            }
            set
            {
                _YBZLFY = value;
