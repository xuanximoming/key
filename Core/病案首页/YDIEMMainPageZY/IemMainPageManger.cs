...
namespace DrectSoft.Core.IEMMainPageZY
{
    public class IemMainPageManger
    {
        ...
        public IemMainPageInfo GetIemInfo()
        {
            try
            {
                DrectSoft.DSSqlHelper.YD_SqlHelper.CreateSqlHelper();
                ...
                SqlParameter[] sqlpars = new SqlParameter[]
                {
                    ...
                    new SqlParameter("@result1",SqlDbType.Structured ),
                    new SqlParameter("@result2",SqlDbType.Structured ),
                    new SqlParameter("@result3",SqlDbType.Structured ),
                };
                sqlpars[0].Value = CurrentInpatient.NoOfFirstPage;
                sqlpars[1].Direction = ParameterDirection.Output;
                sqlpars[2].Direction = ParameterDirection.Output;
                sqlpars[3].Direction = ParameterDirection.Output;
                sqlpars[4].Direction = ParameterDirection.Output;
                DataSet dataSet = DrectSoft.DSSqlHelper.YD_SqlHelper.ExecuteDataSet("IEM_MAIN_PAGE_SX.usp_getieminfo_sx", sqlpars, CommandType.StoredProcedure);
                //SqlParameter[] paraCollection = new SqlParameter[] { new SqlParameter("@NoOfInpat", Int32.Parse(CurrentInpatient.NoOfFirstPage.ToString())) };
                ...
                IemInfo.IemFeeInfo = GetIemFeeZy(CurrentInpatient.NoOfFirstPage.ToString());
                GetIemMainPageExtension(CurrentInpatient.NoOfFirstPage);
                return IemInfo;
            }
            catch (Exception)
            {
        ...
        private void GetIemBasInfo(DataTable dataTable)
        {
            try
            {
                ...
                if (DefaultData.Rows.Count > 0)
                {
                    ...
                    #region ===================Add by xlb 2013-06-18======================
                    //默认实体的出生日期
                    DefaultInfo.Birth = string.IsNullOrEmpty(DefaultData.Rows[0]["Birth"].ToString()) ? "" : DefaultData.Rows[0]["Birth"].ToString().Trim();
                    //默认信息的出生日期年份
                    //Add by xlb 2013-06-18
                    DefaultInfo.BirthYear = string.IsNullOrEmpty(DefaultData.Rows[0]["Birth"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["Birth"].ToString().Trim()).ToString("yyyy");
                    //默认病患信息的出生日期的月部分
                    DefaultInfo.BirthMonth = string.IsNullOrEmpty(DefaultData.Rows[0]["Birth"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["Birth"].ToString().Trim()).ToString("MM");
                    //默认信息的出生日期的天部分
                    DefaultInfo.BirthDay = string.IsNullOrEmpty(DefaultData.Rows[0]["Birth"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["Birth"].ToString().Trim()).ToString("dd");
                    #endregion
                    ...
                    #region ===================入院时间 Add by xlb 2013-06-18===================
                    //入院时间
                    DefaultInfo.AdmitDate = string.IsNullOrEmpty(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()) ? "" : DefaultData.Rows[0]["AdmitDate"].ToString().Trim();
                    //入院时间的年部分
                    DefaultInfo.AdmitDateYear = string.IsNullOrEmpty(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()).ToString("yyyy");
                    //入院日期的月份
                    DefaultInfo.AdmitDateMonth = string.IsNullOrEmpty(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()).ToString("MM");
                    //入院时间的天数
                    DefaultInfo.AdmitDateDay = string.IsNullOrEmpty(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()).ToString("dd");
                    //入院时间的小时部分
                    DefaultInfo.AdmitHour = string.IsNullOrEmpty(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["AdmitDate"].ToString().Trim()).ToString("HH");
                    #endregion
                    ...
                    #region ====================出院时间 Add by xlb 2013-06-18=====================
                    //出院时间
                    DefaultInfo.OutWardDate = string.IsNullOrEmpty(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()) ? "" : DefaultData.Rows[0]["OutHosDate"].ToString();
                    //出院时间的年份
                    DefaultInfo.OutWardDateYear = string.IsNullOrEmpty(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()).ToString("yyyy");
                    //出院时间的月份
                    DefaultInfo.OutWardMonth = string.IsNullOrEmpty(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()).ToString("MM");
                    //出院时间的天数
                    DefaultInfo.OutWardDay = string.IsNullOrEmpty(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()).ToString("dd");
                    //出院时间的小时部分
                    DefaultInfo.OutWardHour = string.IsNullOrEmpty(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()) ? "" : Convert.ToDateTime(DefaultData.Rows[0]["OutHosDate"].ToString().Trim()).ToString("HH");
                    #endregion
                    DefaultInfo.ActualDays = DefaultData.Rows[0]["TOTALDAYS"] == null || string.IsNullOrEmpty(DefaultData.Rows[0]["TOTALDAYS"].ToString()) ? "" : DefaultData.Rows[0]["TOTALDAYS"].ToString();
                ...
                if (PatData.Rows.Count > 0)
                {
                    ...
                    DefaultInfo.NoofRecord = PatData.Rows[0]["noofrecord"].ToString() == "" ? "" : PatData.Rows[0]["noofrecord"].ToString();
                    ...
                    #region 默认实体出生日期 Add by xlb 2013-06-18
                    //出生日期
                    DefaultInfo.Birth = string.IsNullOrEmpty(PatData.Rows[0]["Birth"].ToString().Trim()) ? DefaultInfo.Birth : PatData.Rows[0]["Birth"].ToString();
                    //出生日期的年份
                    DefaultInfo.BirthYear = string.IsNullOrEmpty(PatData.Rows[0]["Birth"].ToString().Trim()) ? DefaultInfo.BirthYear : Convert.ToDateTime(PatData.Rows[0]["Birth"].ToString().Trim()).ToString("yyyy");
                    //出生日期的月份
                    DefaultInfo.BirthMonth = string.IsNullOrEmpty(PatData.Rows[0]["Birth"].ToString().Trim()) ? DefaultInfo.BirthMonth : Convert.ToDateTime(PatData.Rows[0]["Birth"].ToString().Trim()).ToString("MM");
                    //出生日期的天数
                    DefaultInfo.BirthDay = string.IsNullOrEmpty(PatData.Rows[0]["Birth"].ToString().Trim()) ? DefaultInfo.BirthDay : Convert.ToDateTime(PatData.Rows[0]["Birth"].ToString().Trim()).ToString("dd");
                    #endregion
                    ...
                    //默认实体的出生日期的年份
                    DefaultInfo.AdmitDateYear = string.IsNullOrEmpty(PatData.Rows[0]["ADMITDATE"].ToString().Trim()) ? DefaultInfo.AdmitDateYear : Convert.ToDateTime(PatData.Rows[0]["ADMITDATE"].ToString().Trim()).ToString("yyyy");
                    //默认实体的出生日期的月份
                    DefaultInfo.AdmitDateMonth = string.IsNullOrEmpty(PatData.Rows[0]["ADMITDATE"].ToString().Trim()) ? DefaultInfo.AdmitDateMonth : Convert.ToDateTime(PatData.Rows[0]["ADMITDATE"].ToString().Trim()).ToString("MM");
                    //默认实体的出生日期的天数
                    DefaultInfo.AdmitDateDay = string.IsNullOrEmpty(PatData.Rows[0]["ADMITDATE"].ToString().Trim()) ? DefaultInfo.AdmitDateDay : Convert.ToDateTime(PatData.Rows[0]["ADMITDATE"].ToString().Trim()).ToString("dd");
                    //默认实体的小时部分
                    DefaultInfo.AdmitHour = string.IsNullOrEmpty(PatData.Rows[0]["ADMITDATE"].ToString().Trim()) ? DefaultInfo.AdmitHour : Convert.ToDateTime(PatData.Rows[0]["ADMITDATE"].ToString().Trim()).ToString("HH");
                    #endregion
                    ...
                    #region ================出院时间 Add by xlb 2013-06-18==============
                    //默认实体的出院时间
                    DefaultInfo.OutWardDate = string.IsNullOrEmpty(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()) ? DefaultInfo.OutWardDate : PatData.Rows[0]["OUTWARDDATE"].ToString();
                    //默认实体的出院时间年部分
                    DefaultInfo.OutWardDateYear = string.IsNullOrEmpty(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()) ? DefaultInfo.OutWardDateYear : Convert.ToDateTime(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()).ToString("yyyy");
                    //默认实体的出院时间月部分
                    DefaultInfo.OutWardMonth = string.IsNullOrEmpty(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()) ? DefaultInfo.OutWardMonth : Convert.ToDateTime(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()).ToString("MM");
                    //默认实体出院时间的天数
                    DefaultInfo.OutWardDay = string.IsNullOrEmpty(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()) ? DefaultInfo.OutWardDay : Convert.ToDateTime(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()).ToString("dd");
                    //默认实体的出院时间的小时部分
                    DefaultInfo.OutWardHour = string.IsNullOrEmpty(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()) ? DefaultInfo.OutWardHour : Convert.ToDateTime(PatData.Rows[0]["OUTWARDDATE"].ToString().Trim()).ToString("HH");
                    #endregion
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    IemInfo.IemBasicInfo.BirthYear = string.IsNullOrEmpty(row["Birth"].ToString().Trim()) ? "" : Convert.ToDateTime(row["Birth"].ToString().Trim()).ToString("yyyy");
                    IemInfo.IemBasicInfo.BirthMonth = string.IsNullOrEmpty(row["Birth"].ToString().Trim()) ? "" : Convert.ToDateTime(row["Birth"].ToString().Trim()).ToString("MM");
                    IemInfo.IemBasicInfo.BirthDay = string.IsNullOrEmpty(row["Birth"].ToString().Trim()) ? "" : Convert.ToDateTime(row["Birth"].ToString().Trim()).ToString("dd");
                    ...
                    IemInfo.IemBasicInfo.AdmitDateYear = string.IsNullOrEmpty(row["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(row["AdmitDate"].ToString().Trim()).ToString("yyyy");
                    IemInfo.IemBasicInfo.AdmitDateMonth = string.IsNullOrEmpty(row["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(row["AdmitDate"].ToString().Trim()).ToString("MM");
                    IemInfo.IemBasicInfo.AdmitDateDay = string.IsNullOrEmpty(row["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(row["AdmitDate"].ToString().Trim()).ToString("dd");
                    IemInfo.IemBasicInfo.AdmitHour = string.IsNullOrEmpty(row["AdmitDate"].ToString().Trim()) ? "" : Convert.ToDateTime(row["AdmitDate"].ToString().Trim()).ToString("HH");
                    ...
                    IemInfo.IemBasicInfo.OutWardDateYear = row["OutHosDate"].ToString() == "" ? "" : Convert.ToDateTime(row["OutHosDate"].ToString()).ToString("yyyy");
                    IemInfo.IemBasicInfo.OutWardMonth = row["OutHosDate"].ToString() == "" ? "" : Convert.ToDateTime(row["OutHosDate"].ToString()).ToString("MM");
                    IemInfo.IemBasicInfo.OutWardDay = row["OutHosDate"].ToString() == "" ? "" : Convert.ToDateTime(row["OutHosDate"].ToString()).ToString("dd");
                    IemInfo.IemBasicInfo.OutWardHour = row["OutHosDate"].ToString() == "" ? "" : Convert.ToDateTime(row["OutHosDate"].ToString()).ToString("HH");
                    ...
                    //打印需要分开显示时间
                    IemInfo.IemDiagInfo.Quality_Control_DateYear = string.IsNullOrEmpty(row["quality_control_date"].ToString().Trim()) ? "" : Convert.ToDateTime(row["quality_control_date"].ToString().Trim()).ToString("yyyy");
                    IemInfo.IemDiagInfo.Quality_Control_DateMonth = string.IsNullOrEmpty(row["quality_control_date"].ToString().Trim()) ? "" : Convert.ToDateTime(row["quality_control_date"].ToString().Trim()).ToString("MM");
                    IemInfo.IemDiagInfo.Quality_Control_DateDay = string.IsNullOrEmpty(row["quality_control_date"].ToString().Trim()) ? "" : Convert.ToDateTime(row["quality_control_date"].ToString().Trim()).ToString("dd");
                    IemInfo.IemDiagInfo.IemInpatOutHosStatus = string.IsNullOrEmpty(row["outhosstatus"].ToString().Trim()) ? "" : row["outhosstatus"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemDieaseYNZZ = string.IsNullOrEmpty(row["jbynzz"].ToString().Trim()) ? "" : row["jbynzz"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemMZYOutHos = string.IsNullOrEmpty(row["mzycy"].ToString().Trim()) ? "" : row["mzycy"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemInHosYOutHos = string.IsNullOrEmpty(row["inandouthos"].ToString().Trim()) ? "" : row["inandouthos"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemLCYBL = string.IsNullOrEmpty(row["lcybl"].ToString().Trim()) ? "" : row["lcybl"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemFSYBL = string.IsNullOrEmpty(row["fsybl"].ToString().Trim()) ? "" : row["fsybl"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemQJCS = string.IsNullOrEmpty(row["qjcount"].ToString().Trim()) ? "" : row["qjcount"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemSuccessTimes = string.IsNullOrEmpty(row["successcount"].ToString().Trim()) ? "" : row["successcount"].ToString().Trim();
                    IemInfo.IemDiagInfo.IemInpatLY = string.IsNullOrEmpty(row["inpatly"].ToString().Trim()) ? "" : row["inpatly"].ToString().Trim();
                    IemInfo.IemBasicInfo.AsaScore = string.IsNullOrEmpty(row["asaScore"].ToString().Trim()) ? "" : row["asaScore"].ToString().Trim();
                    ///////费用模块
                ...
                if (dataTable.Rows.Count == 0)
                {
                    ...
                    //病案基本信息对象出生日期的年份
                    IemInfo.IemBasicInfo.BirthYear = DefaultInfo.BirthYear;
                    //病案基本信息对象的出生日期的月份
                    IemInfo.IemBasicInfo.BirthMonth = DefaultInfo.BirthMonth;
                    //病案基本信息对象出生日期的天数
                    IemInfo.IemBasicInfo.BirthDay = DefaultInfo.BirthDay;
                    ...
                    //病案基本信息对象的入院时间
                    IemInfo.IemBasicInfo.AdmitDate = string.IsNullOrEmpty(DefaultInfo.AdmitDate) ? "" : DefaultInfo.AdmitDate;
                    //Add by xlb 2013-06-18 入院时间的年份
                    IemInfo.IemBasicInfo.AdmitDateYear = string.IsNullOrEmpty(DefaultInfo.AdmitDateYear) ? "" : DefaultInfo.AdmitDateYear;
                    //Add by xlb 2013-06-18 入院时间的月份
                    IemInfo.IemBasicInfo.AdmitDateMonth = string.IsNullOrEmpty(DefaultInfo.AdmitDateMonth) ? "" : DefaultInfo.AdmitDateMonth;
                    //Add by xlb 2013-06-18 入院时间的天数
                    IemInfo.IemBasicInfo.AdmitDateDay = string.IsNullOrEmpty(DefaultInfo.AdmitDateDay) ? "" : DefaultInfo.AdmitDateDay;
                    //Add by xlb 2013-06-18 入院时间的小时部分
                    IemInfo.IemBasicInfo.AdmitHour = string.IsNullOrEmpty(DefaultInfo.AdmitHour) ? "" : DefaultInfo.AdmitHour;

                    IemInfo.IemBasicInfo.AdmitDeptID = DefaultInfo.AdmitDeptID;
                    IemInfo.IemBasicInfo.AdmitDeptName = DefaultInfo.AdmitDeptName;
                    IemInfo.IemBasicInfo.AdmitWardID = DefaultInfo.AdmitWardID;
                    IemInfo.IemBasicInfo.AdmitWardName = DefaultInfo.AdmitWardName;
                    ...
                    //病案基本信息对象出院日期
                    IemInfo.IemBasicInfo.OutWardDate = DefaultInfo.OutWardDate;
                    //病案基本信息对象出院日期年份
                    IemInfo.IemBasicInfo.OutWardDateYear = DefaultInfo.OutWardDateYear;
                    //病案基本信息对象出院日期月份
                    IemInfo.IemBasicInfo.OutWardMonth = DefaultInfo.OutWardMonth;
                    //病案基本信息对象出院日期天数
                    IemInfo.IemBasicInfo.OutWardDay = DefaultInfo.OutWardDay;
                    //病案基本信息对象出院日期小时部分
                    IemInfo.IemBasicInfo.OutWardHour = DefaultInfo.OutWardHour;
                    IemInfo.IemBasicInfo.OutHosDeptID = DefaultInfo.OutHosDeptID;
                    IemInfo.IemBasicInfo.OutHosDeptName = DefaultInfo.OutHosDeptName;
                    IemInfo.IemBasicInfo.OutHosWardID = DefaultInfo.OutHosWardID;

                    IemInfo.IemBasicInfo.OutHosWardName = DefaultInfo.OutHosWardName;
                    IemInfo.IemBasicInfo.ActualDays = DefaultInfo.ActualDays;//实际住院天数
...
left join ward w1 on i.outhosward=w1.id where noofinpat='{0}'  ", CurrentInpatient.NoOfFirstPage);
        ...
        private void GetItemDiagInfo(DataTable dataTable)
        {
            ...
            //IemInfo.IemDiagInfo.OutDiagTable = YD_BaseService.AddColsDataToDataTable(dt);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public bool SetExetionButton()
        {
            try
            {
                string sql = "select count(*) from iem_mainpage_except where valide='1'";
                YD_SqlHelper.CreateSqlHelper();
                DataTable dtCount = YD_SqlHelper.ExecuteDataTable(sql, CommandType.Text);
        ...
        private void EditIemBasicInfo_sx(IemMainPageInfo info, string type)
        {
            try
            {
                ...
                //参数->病人出院状况
                SqlParameter paraOutStatus = new SqlParameter("@outHosStatus", SqlDbType.VarChar, 20);
                paraOutStatus.Value = info.IemDiagInfo.IemInpatOutHosStatus == null ? "" : info.IemDiagInfo.IemInpatOutHosStatus;
                //参数->对应疾病是否疑难杂症
                SqlParameter paraYNZZ = new SqlParameter("@JBYNZZ", SqlDbType.VarChar, 20);
                paraYNZZ.Value = info.IemDiagInfo.IemDieaseYNZZ == null ? "" : info.IemDiagInfo.IemDieaseYNZZ;
                //参数->门诊与出院
                SqlParameter paraMZCY = new SqlParameter("@MZYCY", SqlDbType.VarChar, 20);
                paraMZCY.Value = info.IemDiagInfo.IemMZYOutHos == null ? "" : info.IemDiagInfo.IemMZYOutHos;
                //参数->指的入院与出院
                SqlParameter paraInAndOutHos = new SqlParameter("@InAndOutHos", SqlDbType.VarChar, 20);
                paraInAndOutHos.Value = info.IemDiagInfo.IemInHosYOutHos == null ? "" : info.IemDiagInfo.IemInHosYOutHos;
                //参数->临床与病理
                SqlParameter paraLCYBL = new SqlParameter("@LCYBL", SqlDbType.VarChar, 20);
                paraLCYBL.Value = info.IemDiagInfo.IemLCYBL == null ? "" : info.IemDiagInfo.IemLCYBL;
                //参数->放射与病理
                SqlParameter paraFSYBL = new SqlParameter("@FSYBL", SqlDbType.VarChar, 20);
                paraFSYBL.Value = info.IemDiagInfo.IemFSYBL == null ? "" : info.IemDiagInfo.IemFSYBL;
                //参数->抢救次数
                SqlParameter paraQJCount = new SqlParameter("@qJCount", SqlDbType.VarChar, 20);
                paraQJCount.Value = info.IemDiagInfo.IemQJCS == null ? "" : info.IemDiagInfo.IemQJCS;
                //成功次数
                SqlParameter paraSuccessCount = new SqlParameter("@successCount", SqlDbType.VarChar, 20);
                paraSuccessCount.Value = info.IemDiagInfo.IemSuccessTimes == null ? "" : info.IemDiagInfo.IemSuccessTimes;
                SqlParameter paraInpatLY = new SqlParameter("@InPatLY", SqlDbType.VarChar);
                paraInpatLY.Value = info.IemDiagInfo.IemInpatLY == null ? "" : info.IemDiagInfo.IemInpatLY;
                SqlParameter paraAsaScore = new SqlParameter("@asaScore", SqlDbType.VarChar, 20);
                paraAsaScore.Value = info.IemBasicInfo.AsaScore == null ? "" : info.IemBasicInfo.AsaScore;
                ...
                paraLATERHOSCOMAHOUR.Value = info.IemBasicInfo.LaterHosComaHour;//LaterHosComaDay谁写错的！！！！add by ywk 2013年8月15日 21:35:44
                ...
                paraZYZLSB,paraZYZLJS,paraBZSH,paraOutStatus,paraYNZZ,paraMZCY,paraInAndOutHos,paraLCYBL,paraFSYBL,paraQJCount,paraSuccessCount,paraInpatLY,paraAsaScore
        };
        ...
        private void InserIemOperInfo_sx(DataRow info, IDataAccess sqlHelper)
        {
            ...
            SqlParameter paraOperInTimes = new SqlParameter("@OperInTimes", SqlDbType.VarChar, 20);
            paraOperInTimes.Value = info == null || string.IsNullOrEmpty(info["OperInTimes"].ToString().Trim()) ? "" : info["OperInTimes"].ToString().Trim();
            SqlParameter[] paraColl = new SqlParameter[] { paraIem_Mainpage_NO, paraOperation_Code, paraOperation_Date, paraOperation_Name, paraExecute_User1, paraExecute_User2, paraExecute_User3,
                paraAnaesthesia_Type_Id,paraClose_Level,paraAnaesthesia_User,paraCreate_User,paraOPERATION_LEVEL,paraOperInTimes };
        ...
        /// 获取病案扩展维护记录
        /// </summary>
        private void GetIemMainPageExtension(decimal NoOfFirstPage)
        {
            try
            {
                string sql = string.Format(@"select  e.iemexname,u.value from iem_mainpage_except e join  iem_mainpage_except_use u on e.iemexid=u.iemexid  and e.valide='1'  where u.noofinpat='{0}'", NoOfFirstPage);
                DataTable dt = m_app.SqlHelper.ExecuteDataTable(sql);
                if (dt == null || dt.Rows.Count <= 0)
                {
                    return;
                }
                IemInfo.IemMainPageExtension.ExtensionData = dt;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public DataTable GetControlsByForm(string assemblyName)
        {
            try
            {
                YD_SqlHelper.CreateSqlHelper();
                DataTable controlData = YD_SqlHelper.ExecuteDataTable(@"select * from iemcontroldefault where valid='1' and controlsrc=@controlSrc",
                new SqlParameter[] { new SqlParameter("@controlSrc", assemblyName) }, CommandType.Text);
                return controlData;
            }
            catch (Exception ex)
            {
        ...
        ///保存中医病案首页的费用信息
        /// </summary>
        /// <param name="iem_MainPage_Fee"></param>
        public static void SaveIemFeeZy(Iem_MainPage_Fee iem_MainPage_Fee)
        {
            try
            {
                #region 参数赋值
            ...
            new SqlParameter("@OWNFEE",SqlDbType.VarChar ),
            new SqlParameter("@YBYLFY",SqlDbType.VarChar ),
            new SqlParameter("@ZYBZLZF",SqlDbType.VarChar ),
            new SqlParameter("@ZYBZLZHZF",SqlDbType.VarChar ),
            new SqlParameter("@YBZLFY",SqlDbType.VarChar ),
            new SqlParameter("@CARE",SqlDbType.VarChar ),
            new SqlParameter("@ZHQTFY",SqlDbType.VarChar ),
            new SqlParameter("@BLZDF",SqlDbType.VarChar ),
            new SqlParameter("@SYSZDF",SqlDbType.VarChar ),
            new SqlParameter("@YXXZDF",SqlDbType.VarChar ),
            new SqlParameter("@LCZDF",SqlDbType.VarChar ),
            new SqlParameter("@FSSZLF",SqlDbType.VarChar ),
            new SqlParameter("@LCWLZLF",SqlDbType.VarChar ),
            new SqlParameter("@SSZLF",SqlDbType.VarChar ),
            new SqlParameter("@MZF",SqlDbType.VarChar ),
            new SqlParameter("@SSF",SqlDbType.VarChar ),
            new SqlParameter("@KFF",SqlDbType.VarChar ),
            new SqlParameter("@ZYZDF",SqlDbType.VarChar ),
            new SqlParameter("@ZYZLF",SqlDbType.VarChar ),
            new SqlParameter("@ZYWZ",SqlDbType.VarChar ),
            new SqlParameter("@ZYGS",SqlDbType.VarChar ),
            new SqlParameter("@ZCYJF",SqlDbType.VarChar ),
            new SqlParameter("@ZYTNZL",SqlDbType.VarChar ),
            new SqlParameter("@ZYGCZL",SqlDbType.VarChar ),
            new SqlParameter("@ZYTSZL",SqlDbType.VarChar ),
            new SqlParameter("@ZYQT",SqlDbType.VarChar ),
            new SqlParameter("@ZYTSTPJG",SqlDbType.VarChar ),
            new SqlParameter("@BZSS",SqlDbType.VarChar ),
            new SqlParameter("@XYF",SqlDbType.VarChar),
            new SqlParameter("@KJYWF",SqlDbType.VarChar),
            new SqlParameter("@CPMEDICAL",SqlDbType.VarChar),
            new SqlParameter("@YLJGZYZJF",SqlDbType.VarChar),
            new SqlParameter("@CMEDICAL",SqlDbType.VarChar),
            new SqlParameter("@BLOODFEE",SqlDbType.VarChar),
            new SqlParameter("@XDBLZPF",SqlDbType.VarChar),
            new SqlParameter("@QDBLZPF",SqlDbType.VarChar),
            new SqlParameter("@NXYZLZPF",SqlDbType.VarChar),
            new SqlParameter("@XBYZLZPF",SqlDbType.VarChar),
             new SqlParameter("@JCYYCXCLF",SqlDbType.VarChar),
              new SqlParameter("@ZLYYCXCLF",SqlDbType.VarChar),
               new SqlParameter("@SSYYCXCLF",SqlDbType.VarChar ),
                new SqlParameter("@OTHERFEE",SqlDbType.VarChar ),
                 new SqlParameter("@VALID",SqlDbType.VarChar )};
                if (string.IsNullOrEmpty(iem_MainPage_Fee.ID))
                {
                    iem_MainPage_Fee.ID = Guid.NewGuid().ToString();
                }
                sqlpars[0].Value = iem_MainPage_Fee.ID;
                sqlpars[1].Value = iem_MainPage_Fee.NOOFINPAT;
                sqlpars[2].Value = iem_MainPage_Fee.Total;
                sqlpars[3].Value = iem_MainPage_Fee.OwnFee;
                sqlpars[4].Value = iem_MainPage_Fee.YBYLFY;
                sqlpars[5].Value = iem_MainPage_Fee.ZYBZLZF;
                sqlpars[6].Value = iem_MainPage_Fee.ZYBZLZHZF;
                sqlpars[7].Value = iem_MainPage_Fee.YBZLFY;
                sqlpars[8].Value = iem_MainPage_Fee.Care;
                sqlpars[9].Value = iem_MainPage_Fee.ZHQTFY;
                sqlpars[10].Value = iem_MainPage_Fee.BLZDF;
                sqlpars[11].Value = iem_MainPage_Fee.SYSZDF;
                sqlpars[12].Value = iem_MainPage_Fee.YXXZDF;
                sqlpars[13].Value = iem_MainPage_Fee.LCZDF;
                sqlpars[14].Value = iem_MainPage_Fee.FSSZLF;
                sqlpars[15].Value = iem_MainPage_Fee.LCWLZLF;
                sqlpars[16].Value = iem_MainPage_Fee.SSZLF;
                sqlpars[17].Value = iem_MainPage_Fee.MZF;
                sqlpars[18].Value = iem_MainPage_Fee.SSF;
                sqlpars[19].Value = iem_MainPage_Fee.KFF;
                sqlpars[20].Value = iem_MainPage_Fee.ZYZDF;
                sqlpars[21].Value = iem_MainPage_Fee.ZYZLF;
                sqlpars[22].Value = iem_MainPage_Fee.ZYWZ;
                sqlpars[23].Value = iem_MainPage_Fee.ZYGS;
                sqlpars[24].Value = iem_MainPage_Fee.ZCYJF;
                sqlpars[25].Value = iem_MainPage_Fee.ZYTNZL;
                sqlpars[26].Value = iem_MainPage_Fee.ZYGCZL;
                sqlpars[27].Value = iem_MainPage_Fee.ZYTSZL;
                sqlpars[28].Value = iem_MainPage_Fee.ZYQT;
                sqlpars[29].Value = iem_MainPage_Fee.ZYTSTPJG;
                sqlpars[30].Value = iem_MainPage_Fee.BZSS;
                sqlpars[31].Value = iem_MainPage_Fee.XYF;
                sqlpars[32].Value = iem_MainPage_Fee.KJYWF;
                sqlpars[33].Value = iem_MainPage_Fee.CPMedical;
                sqlpars[34].Value = iem_MainPage_Fee.YLJGZYZJF;
                sqlpars[35].Value = iem_MainPage_Fee.CMedical;
                sqlpars[36].Value = iem_MainPage_Fee.BloodFee;
                sqlpars[37].Value = iem_MainPage_Fee.XDBLZPF;
                sqlpars[38].Value = iem_MainPage_Fee.QDBLZPF;
                sqlpars[39].Value = iem_MainPage_Fee.NXYZLZPF;
                sqlpars[40].Value = iem_MainPage_Fee.XBYZLZPF;
                sqlpars[41].Value = iem_MainPage_Fee.JCYYCXCLF;
                sqlpars[42].Value = iem_MainPage_Fee.ZLYYCXCLF;
                sqlpars[43].Value = iem_MainPage_Fee.SSYYCXCLF;
                sqlpars[44].Value = iem_MainPage_Fee.OtherFee;
                sqlpars[45].Value = "1";
                #endregion
                YD_SqlHelper.ExecuteNonQuery("iem_main_page_sx.usp_AddOrModIemFeeZY", sqlpars, CommandType.StoredProcedure);
        ...
        /// <returns></returns>
        private Iem_MainPage_Fee GetIemFeeZy(string noofinpat)
        {
            try
            {
                ...
                SqlParameter[] sqlpars = new SqlParameter[]{
            new SqlParameter("v_noofinpat",SqlDbType.VarChar ),
            new SqlParameter("o_result",SqlDbType.Structured)
            };
                sqlpars[0].Value = noofinpat;
                sqlpars[1].Direction = ParameterDirection.Output;
                DataTable dt = DrectSoft.DSSqlHelper.YD_SqlHelper.ExecuteDataTable("iem_main_page_sx.usp_GetIemFeeZYbyInpat", sqlpars, CommandType.StoredProcedure);
                Iem_MainPage_Fee iem_MainPage_Fee = DrectSoft.Common.DataTableToList<Iem_MainPage_Fee>.ConvertToModelOne(dt);
                return iem_MainPage_Fee;
            }
            catch (Exception ex)
            {
