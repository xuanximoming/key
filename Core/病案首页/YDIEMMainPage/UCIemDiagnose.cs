...
namespace DrectSoft.Core.IEMMainPage
{
    public partial class UCIemDiagnose : UserControl
    {
        ...
        #region  疾病诊断编码 Add by xlb 2013-03-22
        /// <summary>
        /// 抓取病历诊断编码
        ...
        private DataTable GetDialogData()
        {
            try
            {
                ...
                DataTable dtDialog = DS_SqlHelper.ExecuteDataTable(sql, CommandType.Text);
                return dtDialog;
            }
            catch (Exception ex)
            {
        ...
        private void BindLueData(LookUpEditor lueInfo, Decimal queryType)
        {
            ...
            //m_DataTableDiag = null;上面已注销 此处可以不要XLB 2013-06-08
        }
        ...
        private void GetUI()
        {
            try
            {
                ...
                //疾病诊断代码 modify by xlb 2013-03-22 医师可选择数据元或手动输入
                ...
                if (this.gridControl1.DataSource != null)
                {
                    ...
                    for (int i = 0; i < dataTable.Rows.Count; i++)
                    {
                        ...
                        imOut["Status_Id_Out"] = row["Status_Id_Out"];//出院病情  大连需求 Add by xlb 2013-05-22
        ...
        private void btnEditOutDiag_Click(object sender, EventArgs e)
        {
            ...
            string statusIdOut = dataRow["Status_Id_Out"].ToString();
            m_DiagInfoForm = new IemNewDiagInfoForm(m_App, "edit", diagcode, statusid, admitinfo, statusIdOut);
            m_DiagInfoForm.ShowDialog();
        ...
        #region 注销 重做了控件无需重绘  xlb 2013-04-25
        ...
        //                e.Graphics.DrawString(control.Text/*文本*/, control.Font/*字体*/, Brushes.Black/*刷子*/, control.Location/*位置*/);
        ...
        #region 注销 统一界面使用lookUpEdit by xlb 2013-03-22
        ///// <summary>
        ///// 浏览疾病诊断编码事件
        ///// Add by xlb 2013-03-22
        ///// </summary>
        ...
        //    try
        //    {
        //        IemDialogForm iemDialog = new IemDialogForm(m_App);
        //        if (iemDialog == null)
        //        {
        //            return;
        //        }
        //        iemDialog.StartPosition = FormStartPosition.CenterParent;
        //        if (iemDialog.ShowDialog() == DialogResult.OK)
        //        {
        //            DataRow row = iemDialog.DataRow;
        //            txtPathologyName.Text = row["Dialog_NAME"].ToString();
        //            txtPathologyID.Text = row["Dialog_ICD"].ToString();
        //        }
        //    }
        //    catch (Exception ex)
        //    {
