...
namespace DrectSoft.Core.IEMMainPage
{
    public class IemMainPageInfo
    {
        ...
        private IemMainPageEntension m_IemExtension=new IemMainPageEntension();
        ...
        /// <summary>
        /// 扩展维护对象
        /// Add by xlb 2013-04-18
        /// </summary>
        public IemMainPageEntension IemMainPageExtension
        {
            get 
            {
                return m_IemExtension;
            }
            set
            {
                m_IemExtension = value;
            }
        }
    ...
    public class Iem_Mainpage_Basicinfo
    {
        ...
        public string RecordNo
        {
            get
            {
                ...
                if (IsBaby == "1")//是婴儿
                {
                    recordNo = MotherPatOfHis;
                }
                else
                {
                    recordNo = PatNoOfHis;//todo
                }
        ...
        /// 入院时间Y
        /// </summary>
        public string AdmitDateYear
        {
            get
            {
                if (AdmitDate != null && AdmitDate != "")
                {
                    return AdmitDate.Split(' ')[0].ToString().Split('-')[0].ToString();
                }
                else
                {
                    return "";
        ...
        /// 入院时间M
        /// </summary>
        public string AdmitDateMonth
        {
            get
            {
                if (AdmitDate != null && AdmitDate != "")
                {
                    return AdmitDate.Split(' ')[0].ToString().Split('-')[1].ToString();
                }
                else
                {
                    return "";
        ...
        /// 入院时间
        /// </summary>
        public string AdmitDateDay
        {
            get
            {
                if (AdmitDate != null && AdmitDate != "")
                {
                    return AdmitDate.Split(' ')[0].ToString().Split('-')[2].ToString();
                }
                else
                {
                    return "";
        ...
        public string AdmitDateHour
        {
            get
            {
                if (AdmitDate != null && AdmitDate != "" && AdmitDate.Split(' ').Count()>1)
                {
                    return AdmitDate.Split(' ')[1].ToString().Split(':')[0].ToString();
                }
                else
                {
                    return "";
        ...
        /// 出院时间Y
        /// </summary>
        public string OutWardDateYear
        {
            get
            {
                if (OutWardDate != null && OutWardDate != "")
                {
                    return OutWardDate.Split(' ')[0].ToString().Split('-')[0].ToString();
                }
                else
                {
                    return "";
        ...
        /// 出院时间M
        /// </summary>
        public string OutWardDateMonth
        {
            get
            {
                if (OutWardDate != null && OutWardDate != "")
                {
                    return OutWardDate.Split(' ')[0].ToString().Split('-')[1].ToString();
                }
                else
                {
                    return "";
        ...
        /// 出院时间D
        /// </summary>
        public string OutWardDateDay
        {
            get
            {
                if (OutWardDate != null && OutWardDate != "")
                {
                    return OutWardDate.Split(' ')[0].ToString().Split('-')[2].ToString();
                }
                else
                {
                    return "";
        ...
        public string OutWardDateHour
        {
            get
            {
                if (AdmitDate != null && AdmitDate != "" && OutWardDate.Split(' ').Count() > 1)
                {
                    return OutWardDate.Split(' ')[1].ToString().Split(':')[0].ToString();
                }
                else
                {
                    return "";
        ...
        #region 新增两个详细地址(湖北省新版病案首页添加) add by cyq 2012-12-26
        /// <summary>
        /// 现住址 详细地址
        /// </summary>
        public string XZZ_DetailAddress { get; set; }

        /// <summary>
        /// 户口地址 详细地址
        /// </summary>
        public string HKDZ_DetailAddress { get; set; }
        #endregion
    ...
    public class Iem_Mainpage_Diagnosis
    {
        ...
        public DataTable OutDiagTable
        {
            get
            {
                if (_OutDiagTable == null)
                {
                    ...
                    //add by cyq 2012-12-25 出院情况
                    DataColumn dcMainpageDiagnosisNo = new DataColumn("iem_mainpage_diagnosis_no", Type.GetType("System.String"));
                    DataColumn dcMainpageNo = new DataColumn("iem_mainpage_no", Type.GetType("System.String"));
                    ...
                    //add by cyq 2012-12-25 出院情况
                    DataColumn dcStatus_Id_Out = new DataColumn("Status_Id_Out", Type.GetType("System.String"));
                    DataColumn dcStatus_Name_Out = new DataColumn("Status_Name_Out", Type.GetType("System.String"));
                    ...
                    _OutDiagTable.Columns.Add(dcMainpageDiagnosisNo);
                    _OutDiagTable.Columns.Add(dcMainpageNo);
                    ...
                    _OutDiagTable.Columns.Add(dcStatus_Id_Out);
                    _OutDiagTable.Columns.Add(dcStatus_Name_Out);
        ...
        public string Quality_Control_DateYear
        {
            get
            {
                if (Quality_Control_Date != null && Quality_Control_Date != "")
                {
                    return Quality_Control_Date.Split('-')[0].ToString();
                }
                else
                {
                    return "";
        ...
        public string Quality_Control_DateMonth
        {
            get
            {
                if (Quality_Control_Date != null && Quality_Control_Date != "")
                {
                    return Quality_Control_Date.Split('-')[1].ToString();
                }
                else
                {
                    return "";
        ...
        public string Quality_Control_DateDay
        {
            get
            {
                if (Quality_Control_Date != null && Quality_Control_Date != "")
                {
                    return Quality_Control_Date.Split('-')[2].ToString();
                }
                else
                {
                    return "";
        ...
        /// 门诊和住院
        /// </summary>
        public string DigMenAndInHop { get; set; }
        /// <summary>
        /// 入院和出院
        /// </summary>
        public string DigInHopAndOutHop { get; set; }
        /// <summary>
        /// 术前和术后
        /// </summary>
        public string DigBeforeOpeAndAfterOper { get; set; }
        /// <summary>
        /// 临床与病理
        /// </summary>
        public string DigLinAndBingLi { get; set; }
        /// <summary>
        /// 入院三日内
        /// </summary>
        public string DigInHopThree { get; set; }
        /// <summary>
        /// 放射和病理
        /// </summary>
        public string DigFangAndBingLi { get; set; }
    }
    #endregion
    ...
    public class Iem_MainPage_Others
    {
        ...
        private string _Other_IEM_MainPage_NO;
        /// <summary>
        /// 病案首页序号
        /// </summary>
        public string OtherIEM_MainPage_NO
        {
            get
            {
                return this._Other_IEM_MainPage_NO;
            }
            set
            {
                _Other_IEM_MainPage_NO = value;
            }
        }
    ...
    public class Iem_MainPage_ObstetricsBaby
    {
        ...
        public string BabyIEM_MainPage_NO
        {
            get
            {
                return this._IEM_MainPage_NO;
        ...
        public string BithDayYear
        {
            get
            {
                if (BithDay != null && BithDay != "")
                {
                    return BithDay.Split(' ')[0].ToString().Split('-')[0].ToString();
                }
                else
                {
                    return "";
        ...
        public string BithDayMonth
        {
            get
            {
                if (BithDay != null && BithDay != "")
                {
                    return BithDay.Split(' ')[0].ToString().Split('-')[1].ToString();
                }
                else
                {
                    return "";
        ...
        public string BithDayDay
        {
            get
            {
                if (BithDay != null && BithDay != "")
                {
                    return BithDay.Split(' ')[0].ToString().Split('-')[2].ToString();
                }
                else
                {
                    return "";
        ...
        public string BithDayHour 
        {
            get
            {
                if (BithDay != null && BithDay != ""&&BithDay.Split(' ').Count()>1)
                {
                    return BithDay.Split(' ')[1].ToString().Split(':')[0].ToString();
                }
                else
                {
                    return "";
        ...
        /// 创建人
        /// </summary>
        public string BabyCreate_User { get; set; }
    ...
    #region 扩展对象维护实体
    public class IemMainPageEntension
    {
        private DataTable m_ExtensionData;

        /// <summary>
        /// 扩展数据表
        /// </summary>
        public DataTable ExtensionData
        {
            get 
            {
                ...
                {
                    //实例化DataTable
                    m_ExtensionData = new DataTable("IemMainExtension");
                    DataColumn dataColumnName = new DataColumn("IemName",typeof(string));
                    DataColumn dataColumnValue = new DataColumn("IemValue",typeof(string));
                    m_ExtensionData.Columns.Add(dataColumnName);
                    m_ExtensionData.Columns.Add(dataColumnValue);
                }
