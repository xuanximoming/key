...
namespace YidanSoft.Core.IEMMainPage
{
    class DrawMainPageUtil
    {
        ...
        public int m_PageHeight = 1050;//用于设定PictureBox的高度
        ...
        private float PrintPatientBaseInfo(Graphics g, float pointY)
        {
            ...
            //出生
            string birth = m_IemMainPageEntity.IemBasicInfo.BirthPrint;
            ...
            //关系
            string relation = m_IemMainPageEntity.IemBasicInfo.RelationshipName;
            ...
            //入院日期
            string inTime = m_IemMainPageEntity.IemBasicInfo.AdmitDatePrint;
            ...
            //转科科别
            string shiftSection = m_IemMainPageEntity.IemBasicInfo.Trans_AdmitDeptName;
            ...
            //出院日期
            string outTime = m_IemMainPageEntity.IemBasicInfo.OutWardDatePrint;
            ...
            //门（急）诊诊断
            string menJiZhenDiaglosis = m_IemMainPageEntity.IemDiagInfo.OutDiagName;
            ...
            //入院诊断
            string InDiaglosis = m_IemMainPageEntity.IemDiagInfo.InDiagName;
            pointX = DrawNameAndValueAndUnderLine(g, pointX, pointY, lineHeight, charWidth, "入院诊断", InDiaglosis, 432, "") + 10;

            //入院后确诊日期
            string inConfirmTime = m_IemMainPageEntity.IemDiagInfo.In_Check_DatePrint;
        ...
        private float PrintOutHospitalDiaglosis(Graphics g, float pointY)
        {
            ...
            DataRow[] drs = dtOutHospitalDiagnosis.Select("Diagnosis_Type_Id = '7' or Diagnosis_Type_Id = '8'");
            for (int i = 0; i < drs.Length; i++)
            {
                ...
                //诊断名称
                string diagnosisName = drs[i]["Diagnosis_Name"].ToString();
                ...
                //出院情况
                string status = drs[i]["Status_id"].ToString();
                int statusID = 0;
                if (status != "")
                {
                ...
                //ICD-10
                string icd10 = drs[i]["Diagnosis_Code"].ToString();
            ...
            //ICD-10
            string zymosisCode = m_IemMainPageEntity.IemDiagInfo.ZymosisID;
        ...
        private float PrintFristPageOther(Graphics g, float pointY)
        {
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Section_DirectorName, m_DefaultValueFont, Brushes.Black,
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.DirectorName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 190;
            //主治医师
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Vs_EmployeeName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 190;
            //住院医师
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Resident_EmployeeName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Refresh_EmployeeName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 190;
            //研究生实习医师
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Master_InterneName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 190;
            //实习医师
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.InterneName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 190;
            //编码员
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Coding_UserName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 190;
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Quality_Control_DoctorName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 160;
            ...
            g.DrawString(m_IemMainPageEntity.IemDiagInfo.Quality_Control_NurseName, m_DefaultValueFont, Brushes.Black,
                new RectangleF(pointX + offsetX + valueStartPointX, pointY + 2, 100, RowHeight), sfVertical);
            pointX = pointX + 145;

            //日期
            string time = m_IemMainPageEntity.IemDiagInfo.Quality_Control_DatePrint;
            pointX = DrawNameAndValueAndUnderLine(g, pointX, pointY + offsetY, lineHeight, charWidth, "日期：", time, 120, "") + 15;
        ...
        private float FuKeChanKeYingEr(Graphics g, float pointY)
        {
            ...
            //出生
            string birth = m_IemMainPageEntity.IemObstetricsBaby.BithDayPrint;
        ...
        private float PrintSecondPageOther(Graphics g, float pointY)
        {
            ...
            pointX = DrawSelectItem(g, pointX, pointY, "1.是  2.否") + 115;
