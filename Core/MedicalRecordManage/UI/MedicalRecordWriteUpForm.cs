...
namespace MedicalRecordManage.UI
{
    ...
    /// 病历补写主界面
    /// </summary>
    public partial class MedicalRecordWriteUpForm : DevBaseForm, IStartPlugIn
    {
        ...
        /// 保存，当前自定义窗体的实体集合
        /// </summary>
        public List<RecordWriteUpModel> listAll = new List<RecordWriteUpModel>();
        DevExpress.Utils.WaitDialogForm m_WaitDialog = null;

        /// <summary>
        /// 
        /// </summary>
        public MedicalRecordWriteUpForm()
        {
            try
            {
                InitializeComponent();
        ...
        #region UserControlDB 通过实体获取已存在的RecordWriteUpModel实体，设置当前显示的窗体
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public void OnButtonClick(object sender, MyControlWriteupEventArgs e)
        {
            foreach (RecordWriteUpModel r in listAll)
            {
