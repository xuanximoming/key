...
{
    public partial class MedicalRecordReadOnly : DevExpress.XtraEditors.XtraUserControl//, IEMREditor
    {
        #region 相关方法
        public MedicalRecordReadOnly()
        {
            try
            {
                InitializeComponent();
        ...
        private void InitializeParameters()
        {
            try
            {
                this.dateAdmitStart.DateTime = System.DateTime.Today.AddMonths(-1);
                this.dateAdmitEnd.DateTime = System.DateTime.Today;
                this.dateLeaveStart.DateTime = System.DateTime.Today.AddMonths(-1);
