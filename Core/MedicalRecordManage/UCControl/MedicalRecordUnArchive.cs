...
namespace MedicalRecordManage.UCControl
{
    ...
    /// 未归档病历界面
    /// </summary>
    public partial class MedicalRecordUnArchive : DevExpress.XtraEditors.XtraUserControl
    {
        public MedicalRecordUnArchive()
        {
            InitializeComponent();
        }
        ...
        private void BrowserMedicalRecord(bool bolMessage)
        {
            try
            {
                ...
                DrectSoft.Core.RecordManage.EmrBrowser frm = new DrectSoft.Core.RecordManage.EmrBrowser(noOfFirstPage, SqlUtil.App, floaderState);
