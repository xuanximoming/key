...
namespace MedicalRecordManage.UCControl
{
    ...
    public partial class MedicalRecordBrowse : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void OpenCommandDialog(int flag)
        {
            try
            {
                ...
                if (refresh > 0)
                {
                    MedicalRecordBrowseForm info = this.FindForm() as MedicalRecordBrowseForm;                  
                    foreach (RecordModel rd in info.listAll)
                    {
    ...
    public class MyControlEventArgs : EventArgs
    {
        ...
        private bool _IsOK;
        private MedicalRecordBrowse _medicalRecordBrowse;    
        public MyControlEventArgs(bool isOK, string res,MedicalRecordBrowse medicalRecordBrowse)
        {
            _IsOK = isOK;
            _Result = res;
        ...
        public MedicalRecordBrowse MyMedicalRecordBrowse
        {
