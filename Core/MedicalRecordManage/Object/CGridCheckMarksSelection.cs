...
namespace MedicalRecordManage.Object
{
    ...
    public class CGridCheckMarksSelection
    {
        ...
        public CGridCheckMarksSelection()
        {
            selection = new ArrayList();
        }

        public CGridCheckMarksSelection(GridView view)
            : this()
        {
            View = view;
        }
        ...
        protected int GetCheckBoxWidth()
        {
            DevExpress.XtraEditors.ViewInfo.CheckEditViewInfo info = 
                edit.CreateViewInfo() as DevExpress.XtraEditors.ViewInfo.CheckEditViewInfo;
            int width = 0;
